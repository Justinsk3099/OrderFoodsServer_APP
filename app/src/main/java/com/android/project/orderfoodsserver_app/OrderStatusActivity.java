...
import com.android.project.orderfoodsserver_app.adapter.viewholder.OrderViewHolder;
...
import com.android.project.orderfoodsserver_app.model.NotificationModel;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapShot: dataSnapshot.getChildren()) {
                            ...
                            //Make raw payload
                            NotificationModel notificationModel = new NotificationModel("Hello", "Your order #" + key + " was updated '" + Common.convertCodeToStatus(item.getStatus()) + "'");
